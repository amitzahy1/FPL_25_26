...
export const ORDER = [
    ...
    'defcon_hit_rate', 'def_contrib_per90', 'rotation_risk',
    'xGI_per90', 'goals_scored_assists', 'xDiff',
    'next_3_fdr', 'fixtures', 'minutes', 'bonus_per90', 'clean_sheets_per90', 'now_cost',
